...
char r308_verifypassword(void) {
  ...
  char varpass[] = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00,
...
char r308_genchar(char id) {
  ...
  char genchar[]
      = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00, 0x04, 0x02, id, 0x00, id + 0x07};
...
char r308_store(char id) {
  ...
  uint8_t stor[] = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01,          0x00,
                    0x06, 0x06, id,   0x00, id,   0x00, 0x0D + id + id};
...
uint16_t r308_search(void) {
  ...
  char serch1[] = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00, 0x08,
                   0x04, 0x01, 0x00, 0x01, 0x00, 0x80, 0x00, 0x8F};
...
char r308_deletechar(int id) {
  ...
  uint8_t del_fing[]
      = {0xEF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00, 0x07, 0x0c, 0, 0, 0x00, 0x01, 0, 0};
  uint16_t s   = 0x15 + id;
