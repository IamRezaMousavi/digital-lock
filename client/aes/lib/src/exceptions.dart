...
enum AesFileExceptionType {
  /// Exception of this type is thrown when [AesFileMode] is set as
  /// [AesFileMode.warn] and some encryption or decryption function
...
///
/// At present there is only one type: [AesFileExceptionType.destFileExists].
/// AesCryptException having AesCryptExceptionType.destFileExists type is thrown
/// when overwrite mode set as [AesFileMode.warn] and there is a file with the same name
...
class AesCryptException implements Exception {
  ...
  final AesFileExceptionType type;
